...
function mt(e = J.visualDuration, t = J.bounce) {
  ...
  let w = {
    ...
    toString: () => {
      let e = Math.min(st(w), Yc),
        t = Jc((t) => w.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function pn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    if (T.MotionHandoffAnimation) {
      let n = dn(e);
      if (n) {
        let e = T.MotionHandoffAnimation(n, t, R);
  ...
  let [r, i, a] = Tn(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        ...
        c = (e) => {
          s(e, r === T || r === document || n.useGlobalTarget || Du(r, e.target));
        },
        l = (e) => {
          s(e, !1);
        };
  ...
  return (
    ...
    () => {
      (zu.delete(e),
        !zu.size &&
          typeof Bu == `function` &&
          (T.removeEventListener(`resize`, Bu), (Bu = void 0)));
    }
  );
}
function Vn(e, t) {
...
function bi(e) {
  ...
  if (T.MotionHasOptimisedAnimation(n, `transform`)) {
    ...
    T.MotionCancelOptimisedAnimation(n, `transform`, R, !(t || r));
  }
  let { parent: r } = e;
...
function da(e) {
  let { initial: t, animate: r } = ua(e, n(uf));
...
function _a(e, t, n, r) {
  let i = v(() => {
    let n = mf();
    return (Pr(n, t, _d(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function $a(e) {
  let [t, r] = Zi(),
    i = n(ks);
  return b(If, { ...e, layoutGroup: i, switchLayoutGroup: n(ff), isPresent: t, safeToRemove: r });
}
function eo(e, t, n) {
  let { props: r } = e;
...
function ko(e, t) {
  return T === void 0 ? !1 : e ? kl() && !!bo(t) : Ol();
}
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if ((w > 0 && yt(u, w), c.length === 1 && c.unshift(null), m && `${m}${vp}`, m && m < vp)) {
          let e = b > 0 ? _ / b : 0;
          b = qo(b, m, _);
          let t = [...c],
            n = [...u];
        ...
        let T = ee + b;
        (Xo(r, c, y, u, ee, T), (g = Math.max(x + b, g)), (f = Math.max(T, f)));
      };
    if (X(p)) {
      let e = es(p, s);
      _(m, h, ts(`default`, e));
...
function bs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  ...
  return b(s, {
    ...
    ref: m,
    ignoreStrict: !0,
    children: b(Ep.Provider, { value: p, children: e }),
  });
}
function xs(e, t) {
  ...
  return b(u, {
    ...
    onDrag: (e, t) => {
      let { velocity: n, point: i } = t,
        o = f[m].get();
      (g(r, o, n[m]), Es(_.current, i[m], m, n[m]), a && a(e, t));
    },
    onDragEnd: (e, t) => {
      (Ss(), o && o(e, t));
    },
...
var ks,
  ...
  Fp = t(() => {
    (o(),
      ...
      (El = (e) => e.startsWith(`--`)),
      (Dl = {}),
      (Ol = It(() => T.ScrollTimeline !== void 0, `scrollTimeline`)),
      (kl = It(() => T.ViewTimeline !== void 0, `viewTimeline`)),
      (Al = It(() => {
        try {
      ...
      (Su = class extends Tl {
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = T.pageYOffset),
            (this.measuredOrigin = Y[n](e.measureViewportBox(), T.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = Y[t](e.measureViewportBox(), T.getComputedStyle(e.current))),
      ...
      (Yd = xi({
        ...
        defaultParent: () => {
          if (!Jd.current) {
            let e = new Kd({});
            (e.mount(T), e.setOptions({ layoutScroll: !0 }), (Jd.current = e));
          }
          return Jd.current;
        },
        resetTransform: (e, t) => {
      ...
      (Zd = ({
        ...
        return (
          ...
          b(Ms.Provider, { value: _, children: e })
        );
      }),
      (Qd = (e) => e.key || ``),
      ($d = ({
        ...
        if (g !== ee) {
          ...
          return (s === `wait` && E.length && (e = E), te(Qi(e)), w(g), null);
        }
      ...
      (rf = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        c.current === null &&
          (nf(r) && u && (t = t ? u + `-` + t : u),
          (c.current = { id: t, group: (tf(r) && i.group) || Gi() }));
        let d = v(() => ({ ...c.current, forceRender: o }), [s]);
        return b(ks.Provider, { value: d, children: e });
      }),
      (af = a({ strict: !1 })),
      (of = {
        animation: [
    ...
    ((uf = a({})),
      ...
      (wf = (e, t) => Math.abs(e - t)),
      (Tf = (e, t) => ((t.isSVG ?? va(e)) ? new vd(t) : new dd(t, { allowProjection: e !== u }))),
      ...
      (cp = new WeakMap()),
      (lp = new WeakMap()),
      (up = (e) => (e === document.scrollingElement ? T : e)),
      (dp = [
        [rp.Enter, `entry`],
        [rp.Exit, `exit`],
        [rp.Any, `cover`],
...
//# sourceMappingURL=motion.DPkvUqHs.mjs.map
