...
import { _ as B, v as V } from "./shared-lib.DiWTMVhJ.mjs";
  ...
  let m = l(M, {
    children: l(z, {
      children: l(P, {
        ...
        collectionUtils: Y,
        framerSiteId: X,
        notFoundPage: O(() => import(`./shared-lib.DiWTMVhJ.mjs`).then((e) => (e.i(), e.r))),
        ...
        loadSnippetsModule: new L(
          () => import(`./y6bbUVVh0DQ8_l8_xF1Elk8aFvhNHsVBKBqkB0Io0sM.8HolX1qo.mjs`)
        ),
  ...
  if (
    ...
    (q = {
      augiA20Il: {
        ...
        page: O(() => import(`./be2nQB644Am1H_8r3_8vWNyA1Miy2PCnsyrwBOrQavA.BLDzFGCJ.mjs`)),
        path: `/`,
      },
    }),
...
//# sourceMappingURL=script_main.NFEvW5dJ.mjs.map
