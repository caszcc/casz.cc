...
import { _ as B, v as V } from "./shared-lib.DjuMVkZv.mjs";
  ...
  let m = l(M, {
    children: l(z, {
      children: l(P, {
        ...
        collectionUtils: Y,
        framerSiteId: X,
        notFoundPage: O(() => import(`./shared-lib.DjuMVkZv.mjs`).then((e) => (e.i(), e.r))),
        ...
        loadSnippetsModule: new L(
          () => import(`./2L4tSr07jayBaltNNhUjK0qRx7X3tCt1yEcuDnaZBaw.38GZzmOq.mjs`)
        ),
  ...
  if (
    ...
    (q = {
      augiA20Il: {
        ...
        page: O(() => import(`./be2nQB644Am1H_8r3_8vWNyA1Miy2PCnsyrwBOrQavA.Ct1NcoPk.mjs`)),
        path: `/`,
      },
    }),
...
//# sourceMappingURL=script_main.Cgtm1mHz.mjs.map
