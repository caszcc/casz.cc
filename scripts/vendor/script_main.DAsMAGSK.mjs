...
import { _ as B, v as V } from "./shared-lib.hDMLc68T.mjs";
  ...
  let m = l(M, {
    children: l(z, {
      children: l(P, {
        ...
        collectionUtils: Y,
        framerSiteId: X,
        notFoundPage: O(() => import(`./shared-lib.hDMLc68T.mjs`).then((e) => (e.i(), e.r))),
        ...
        loadSnippetsModule: new L(
          () => import(`./hLIkN2Rt5SgZ1H0UZovjLKuerZpe6nYXgfD6n_hvZUo.CaHwY91V.mjs`)
        ),
  ...
  if (
    ...
    (q = {
      augiA20Il: {
        ...
        page: O(() => import(`./be2nQB644Am1H_8r3_8vWNyA1Miy2PCnsyrwBOrQavA.B-jSHB0R.mjs`)),
        path: `/`,
      },
    }),
...
//# sourceMappingURL=script_main.DAsMAGSK.mjs.map
