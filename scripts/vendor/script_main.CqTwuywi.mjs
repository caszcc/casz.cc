...
import { _ as B, v as V } from "./shared-lib.DofAvAFf.mjs";
  ...
  let m = l(M, {
    children: l(z, {
      children: l(N, {
        ...
        collectionUtils: Y,
        framerSiteId: X,
        notFoundPage: O(() => import(`./shared-lib.DofAvAFf.mjs`).then((e) => (e.i(), e.r))),
        ...
        LayoutTemplate: H,
        loadSnippetsModule: new I(
          () => import(`./2L4tSr07jayBaltNNhUjK0qRx7X3tCt1yEcuDnaZBaw.B8tzpCDl.mjs`)
        ),
  ...
  if (
    ...
    (q = {
      augiA20Il: {
        ...
        page: O(() => import(`./O9BUZo7xfvJuwnvmLtsdKbaqdLaDS3vEfCQk-VoV5tM.DMBRR25z.mjs`)),
        path: `/`,
      },
    }),
    ...
    ((b.__framer_importFromPackage = (e, t) => () =>
      l(F, { error: `Package component not supported: "` + t + `" in "` + e + `"` })),
    ...
    Z &&
      v(() => {
        _(
          ...
          l(d, {}, l(p(() => import(`./shared-lib.DofAvAFf.mjs`).then((e) => (e.n(), e.t)))))
        );
      });
  })();
})();
export { U as getLayoutTemplateBreakpoints, W as getPageRoot };
//# sourceMappingURL=script_main.CqTwuywi.mjs.map
